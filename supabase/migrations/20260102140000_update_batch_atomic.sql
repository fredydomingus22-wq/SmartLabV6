-- Function to atomically update multiple lab_analysis records
-- This function is SECURITY DEFINER to allow execution by users who might have restricted RLS on the table directly/
-- but are authorized to execute this business logic.
...
BEGIN
  ...
  LOOP
    ...
    SET
      ...
      status = (result_record->>'status')::analysis_status_enum,
