                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 max-w-[1700px] mx-auto">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge variant="outline" className="h-7 px-3 text-[10px] font-black uppercase tracking-tighter bg-amber-500/10 text-amber-400 border-amber-500/20 rounded-full animate-pulse-slow">
                                Asset Intelligence
                            </Badge>
                        </div>
                        <h1 className="text-4xl font-black tracking-tighter uppercase flex items-center gap-4">
                            <div className="h-10 w-1 pt-1 bg-gradient-to-b from-amber-500 to-orange-600 rounded-full" />
                            Process <span className="text-slate-500">Equipment</span>
                        </h1>
                        <p className="text-sm text-slate-400 font-medium tracking-tight flex items-center gap-2">
                            <Settings2 className="h-4 w-4 text-amber-500/50" />
