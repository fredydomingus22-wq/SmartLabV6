...
export function CreateCAPADialog({ users }: CreateCAPADialogProps) {
                            ...
                            <div className="flex items-center gap-2">
                                <Switch
                                    onCheckedChange={(checked) => {
                                        const input = document.getElementById("training_required_input_standalone") as HTMLInputElement;
                                        if (input) input.value = checked ? "true" : "false";
                                    }}
                                />
                                <input type="hidden" id="training_required_input_standalone" name="training_required" defaultValue="false" />
                            </div>
                        </div>
                    </div>
                </ActionForm>
