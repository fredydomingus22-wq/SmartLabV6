    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <PageHeader
                ...
                overline="Inbox Industrial • Orquestração MES-LIMS"
                title="Pedidos de Amostragem"
                description="Monitorize e execute pedidos de amostragem gerados pelo sistema ou manualmente."
                backHref="/lab"
                actions={
                    <div className="flex items-center gap-2">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="h-9 w-64 bg-slate-900/50 border border-slate-800 rounded-xl pl-10 text-[10px] uppercase font-black tracking-widest focus:ring-amber-500/20 outline-none text-white placeholder:text-slate-600 transition-all"
                            />
                        </div>
                        <Button variant="outline" className="h-9 border-slate-800 bg-slate-900/50 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-800 transition-all">
