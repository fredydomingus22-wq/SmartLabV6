...
import { Plus, Edit, FlaskConical, Clock } from "lucide-react";
...
export default async function SampleTypesPage() {
    ...
    return (
        <div className="space-y-6">
            <header className="flex flex-col gap-1 pb-4 border-b border-slate-800/60">
                ...
                <p className="text-sm text-muted-foreground w-full md:w-2/3">
                    Configure os templates de amostras utilizados no laboratório. Defina prefixos de codificação, categorias de teste e SLAs padrão.
                </p>
            </header>
